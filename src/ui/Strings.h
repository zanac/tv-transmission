...
enum class Str {
    ...
    MenuPanelsMenu, MenuPanelStatus, MenuPanelFiles,
    MenuPanelResizeStatus, MenuPanelResizeFiles,
    MenuHelp, MenuAbout, DialogTitleAbout, LabelAboutVersion, LabelAboutCopyright,
    MenuSettingsMenu, MenuColumnsMenu,
    MenuConnectionsMenu, MenuConnectionsEmpty,
    LabelFilterName, LabelFilterStatusSection, ButtonReset,
    ...
    WindowTitleFiles,
    HeaderFileName, HeaderFileSize, HeaderFileProgress,
    HeaderFileEnable,
    ValueMixed,
