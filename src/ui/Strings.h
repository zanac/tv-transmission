...
enum class Str {
    ...
    SectionTransfer, LabelAvailable, LabelDownloadedTotal, LabelUploadedTotal,
    LabelAverageSpeed,
    SectionActivity, LabelLastActivity,
    SectionTimeElapsed, LabelTimeDownloading, LabelTimeSeeding,
